...
from dee.utils import default_load_json, default_dump_json, EPS, BERTChineseCharacterTokenizer
from dee.event_type import common_fields, event_type_fields_list
from dee.ner_model import BertForBasicNER, judge_ner_prediction
...
class NERFeatureConverter(object):
    ...
    def convert_example_to_feature(self, ner_example, log_flag=False):
        ...
        # Use BIEOS format.
        ex_entity_labels = ner_example.get_char_entity_labels_bieos()
